...
function refreshPaginationProduct() {
    $('.pagination-kadkidz').empty();

    $('.pagination-kadkidz').removeData("twbs-pagination");

    $('.pagination-kadkidz').unbind("page");

    $('.pagination-kadkidz').twbsPagination({
        totalPages: Math.ceil(total_item_product / viewperpage_product),
        visiblePages: 5,
        onPageClick: function (event, page) {
            if (page > 1) {
                $(".c000001-product-item").hide();
                $(".c000001-product-item").slice(page * viewperpage_product - viewperpage_product, page * viewperpage_product).show('fade');
//
//                        $('.c000001-product-item').hide();
//                        $('.c000001-product-item').slice(page * viewperpage_product - viewperpage_product, page * viewperpage_product).show();
                ...
                $(".c000001-product-item").hide();
                $(".c000001-product-item").slice(0, viewperpage_product).show('fade');
//
//                        $('.c000001-product-item').hide();
//                        $('.c000001-product-item').slice(0, viewperpage_product).show();
            }
